<?php
  ...
  //List of roster
	...
	$roster[$i]['img'] = "img/roster/logout.jpg";
	$roster[$i]['desc'] = "Dovrebbe prendere spunto dal suo nome e fare un favore al mondo staccando la spina al proprio computer e modem.";
	$roster[$i]['cit'] = "\"Wei zio come va?? l'altro giorno ho giocato cn un babbo assurdo\"";
	$i++;
