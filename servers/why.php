...
<?php if($_SESSION['language']=="it"){?>
	...
	<p>Ci&ograve che facciamo &egrave; dunque <strong>creare un'alternativa</strong> ai prodotti che ci propone il mercato che spesso <strong>mancano</strong> della qualit&agrave; necessaria oppure hanno <strong>prezzi proibitivi</strong>.</p>
