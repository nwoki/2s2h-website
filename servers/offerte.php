    ...
    <div class="accordion">
      ...
      <div>
        ...
        <ul class="list" >
            ...
            <li>Server voIP 10 slot codec speex 12,3kbps o superiore</li>
      ...
      <div>
        <ul class="list">
          ...
          <li>Server voIP da 15 slot, codec speex 16,3kbps o superiore</li>
      ...
      <div>
        <p>Questo pacchetto consiste in un <strong>server</strong> di <strong>gioco privato</strong></p>
          <ul class="list">
            ...
            <li>Server voIP da 20 slot codec speex 19,5kbps o superiore</li>
            <li>Controllo server di gioco: <strong>rcon</strong></li>
            <li>Controllo server voIP: <strong>server admin</strong></li>
          </ul>
          <strong>Confronto prezzi</strong>:<br/>
      ...
      <div>
        <ul class="list">
          ...
          <li>Server voIP da 25 slot codec speex 25,9kbps o superiore</li>
          <li>Controllo server di gioco: <strong>rcon, BanBot</strong></li>
          <li>Controllo server voIP: <strong>server admin</strong></li>
        </ul>
        <strong>Confronto prezzi</strong>:<br/>
    ...
    <div class="accordion">
      ...
      <div>
        ...
        <ul class="list" >
            ...
            <li>Server voIP 10 slots codec speex 12,3kbps or higher</li>
    ...
    <h3><a href="#">cw essential pack &euro; 16,00</a></h3>
      <div>
        <ul class="list">
          ...
          <li>VoIP server 15 slot, codec speex 16,3kbps or higher</li>
      ...
      <div>
        <p>The cw plus package consists of a <strong>private game server</strong> with:</p>
          <ul class="list">
            ...
            <li>VoIP server 20 slot, codec speex 19,5kbps or higher</li>
            <li>Game server controls: <strong>rcon</strong></li>
            <li>VoIP server controls: <strong>server admin</strong></li>
          </ul>
          <strong>Comparing prices</strong>:<br/>
      ...
      <div>
        <ul class="list">
          ...
          <li>VoIP server 25 slots, codec speex  25,9kbps or higher</li>
          <li>Game server controls <strong>rcon, BanBot</strong></li>
          <li>VoIP server controls: <strong>server admin</strong></li>
        </ul>
        <strong>Comparing prices</strong>:<br/>
