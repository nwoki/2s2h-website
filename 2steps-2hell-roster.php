...
<body>
    ...
    <div id="n3m3s1s" >
        <fieldset>
            ...
            <img src="imghold/people/n3m3s1s.jpg" align="left" alt="nemesis-foto" width="20%"/>
            <p>
    ...
    <div id="zamy" >
        <fieldset>
            ...
            <img src="imghold/people/anonymous.jpg" align="right" alt="nemesis-foto" width="20%"/>
            <p>
                inserire descrizione
            </p>
        </fieldset>
    ...
    <div id="heresyarch" >
        <fieldset>
            ...
            <img src="imghold/people/nic.jpg" align="left" alt="nemesis-foto" width="20%"/>
            <p>
                inserire descrizione
            </p>
        </fieldset>
    ...
    <div id="revan" >
        <fieldset>
            ...
            <img src="imghold/people/revan.jpg" align="right" alt="nemesis-foto" width="20%"/>
            <p>
                inserire descrizione
            </p>
        </fieldset>
    ...
    <div id="kolbebo" >
        <fieldset>
            ...
            <img src="imghold/people/anonymous.jpg" align="left" alt="nemesis-foto" width="20%"/>
            <p>
                inserire descrizione
            </p>
        </fieldset>
    ...
    <div id="roger" >
        <fieldset>
            ...
            <img src="imghold/people/roger.jpg" align="right" alt="nemesis-foto" width="20%"/>
            <p>
                inserire descrizione
            </p>
        </fieldset>
